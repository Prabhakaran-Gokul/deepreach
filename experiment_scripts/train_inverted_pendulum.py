...
p.add_argument('--omega_max', type=float, default=1.1, required=False, help='Turn rate of the pendulum')
...
dataset = dataio.ReachabilityInvertedPendulumSource(numpoints=65000, length=1, mass=1, omega_max=opt.omega_max, pretrain=opt.pretrain, tMin=opt.tMin,
...
# Define the loss
loss_fn = loss_functions.initialize_inverted_pendulum(dataset, opt.minWith)
